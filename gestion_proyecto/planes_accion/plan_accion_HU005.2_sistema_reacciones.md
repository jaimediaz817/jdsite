...
| --------- | ------------------------------------------------------------------- | --------------- | ----------- |
| 🔹 FASE 1  | Crear modelo `BlogReaction` + migración                             | 8 min           | ⏳ Pendiente |
| 🔹 FASE 2  | Crear lógica de negocio y servicio de reacciones                    | 10 min          | ⏳ Pendiente |
| 🔹 FASE 3  | Crear endpoints API minimalistas                                    | 7 min           | ⏳ Pendiente |
| 🔹 FASE 4  | Añadir middleware rate limit y detección de robots                  | 6 min           | ⏳ Pendiente |
